...
{
	resultsDockWidget->createTestCasesTabs(testCasesCount, testCaseInputs, testCaseOutputs, testProgramOutputs, testCaseState, outputInfoList, programOutputInfoList, workingDirectory);
}
