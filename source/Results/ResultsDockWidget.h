...
{
private:
    QFileInfoList testCaseInputInfo;
    QFileInfoList testCaseOutputInfo;
    Q_OBJECT
...
public:
    ...
    void createTestCasesTabs(int testCasesCount
                             ...
                             , const QFileInfoList &inputInfoList, const QFileInfoList &outputInfoList
                             , const QFileInfoList &programOutputInfoList
                             , const QDir workingDirectoryPath );
public slots:
    void createTabs(int index, QString outputHTMLPath);
