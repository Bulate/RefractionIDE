...

{
    ...
    testCaseInputInfo = inputInfoList;
    testCaseOutputInfo = outputInfoList;
...
void ResultsDockWidget::createTabs(int index, QString outputHTMLPath)
{
    ...
    QFile* tempOutputFile = new QFile (this->testCaseOutputInfo.at(index).absoluteFilePath());
    standardInputOutputInspector->setInput(tempInputFile);
